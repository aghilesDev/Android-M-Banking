...
public class UserParticulier extends  User {
    ...
    public UserParticulier(int ID, String userId, String type, String telephone, String nom, String prenom, String date_Naissance, String lieu_Naissance, String situation_Familiale, String email, String sexe, String adresse) {
